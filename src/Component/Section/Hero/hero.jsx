...
export default function Hero(props) {
  ...
  return (
    <div className="hero-container">
      ...
      <Intro intro_data={props.intro_data} />
    </div>
  )
}
