...
export default function Header() {
  const toggleDotOnMouseOver = (id) => {
    const dot = document.querySelector('#'+id+' svg');
    dot.style.display = 'block';
  }

  const toggleDotOnMouseOut = (id) => {
    const dot = document.querySelector('#'+id+' svg');
      ...
      <div className='header'>
        <div className="header-start">
          ...
          <div className="header-menu">
            <ul>
              <li id="home"><a href="#" onMouseOver={() => toggleDotOnMouseOver('home')} onMouseOut={() => toggleDotOnMouseOut('home')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>Home</span>
              </a></li>
              <li id="about"><a href="#" onMouseOver={() => toggleDotOnMouseOver('about')} onMouseOut={() => toggleDotOnMouseOut('about')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>About</span>
              </a></li>
              <li id="programs"><a href="#" onMouseOver={() => toggleDotOnMouseOver('programs')} onMouseOut={() => toggleDotOnMouseOut('programs')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>Programs</span>
              </a></li>
              <li id="admissions"><a href="#" onMouseOver={() => toggleDotOnMouseOver('admissions')} onMouseOut={() => toggleDotOnMouseOut('admissions')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>Admissions</span>
              </a></li>
              <li id="parents"><a href="#" onMouseOver={() => toggleDotOnMouseOver('parents')} onMouseOut={() => toggleDotOnMouseOut('parents')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>Parents</span>
              </a></li>
              <li id="location"><a href="#" onMouseOver={() => toggleDotOnMouseOver('location')} onMouseOut={() => toggleDotOnMouseOut('location')}>
                <svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="currentColor"><path d="M480.2-240Q380-240 310-309.8q-70-69.8-70-170T309.8-650q69.8-70 170-70T650-650.2q70 69.8 70 170T650.2-310q-69.8 70-170 70Z" /></svg>
                <span>Location</span>
              </a></li>
            </ul>
